...
namespace Tamagotchi
{
    ...
    public partial class Kitchen : ContentPage
    {
        ...
        {
            DrumstickButton.TranslateTo(120, 185, 1500, Easing.CubicOut);
            DrumstickButton.ScaleTo(0f, 2800, Easing.CubicOut);
            Hunger = 1;
        }

        private void GiveDrink(object sender, EventArgs e)
        {
            SodaButton.TranslateTo(155, 165, 1500, Easing.CubicOut);
            SodaButton.ScaleTo(0f, 2800, Easing.CubicOut);
            Thirst = 1;
        }
    }
}